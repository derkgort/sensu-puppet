...
Puppet::Type.type(:sensugo_cluster_role_binding).provide(:sensuctl, :parent => Puppet::Provider::Sensuctl) do
  desc "Provider sensugo_cluster_role_binding using sensuctl"
